...
class UDPSocket : public CommunicatingSocket {
 public:
   ...
   */
  void sendTo(const void *buffer, size_t bufferLen, const string &foreignAddress,
   ...
   */
  int recvFrom(void *buffer, size_t bufferLen, string &sourceAddress, unsigned short &sourcePort) noexcept(false);
